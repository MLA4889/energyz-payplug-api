...
app = FastAPI(title="Energyz Payment Automation", version="2.0")
...
async def quote_from_monday(request: Request):
    try:
        ...
        # On lit toutes les colonnes utiles (email, adresse, description, HT, TVA…)
